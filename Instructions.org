...
*N.B.:* =min_timestep_limit= is set to 0.1 seconds, too high for
...
the problematic equation (*N.B.:* this is untested by us!). You probably
...
may have a science-grade setup now! (*N.B.:* do not attempt this *during*
