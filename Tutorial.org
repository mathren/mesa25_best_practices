...
:Hint:
You can inspect the [[./15Msun_problem/15M_early_evol.mod][output *.mod file]], [[./15Msun_early_evol/LOGS/15M_early_evol.data][profile file]], and [[./15Msun_early_evol/LOGS/history.data][history file]] or
just look at the [[./15Msun_problem/early_evolution.mp4][pgstar movie]] to see your initial conditions.
:end:
